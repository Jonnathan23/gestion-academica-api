...
export class ModuleEntity {
    constructor(
        public mo_id: string, public mo_name: string, public mo_description: string,
        public mo_created_at: string, public mo_updated_at: string, private student_modules: StudenModules[],
    ) { }
}
```
...
export class CreateModuleDto {
    private constructor(public readonly mo_name: string, public readonly mo_description: string) { }
...
export class ModuleController {
    ...
    createModule = (req: Request, res: Response, next: NextFunction) => {
        ...
        new CreateModule(this.moduleRepository).execute(createModuleDto!)
