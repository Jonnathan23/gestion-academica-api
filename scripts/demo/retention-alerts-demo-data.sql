...
-- Alerta 1: Andrea Torres (PENDING, 15 días de ausencia)
...
SELECT 
    ...
    15, false, null, null,
    'Estudiante no ha asistido a clases por 15 días consecutivos. Se le envió un correo recordatorio.', 'PENDING', null, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM "Students" WHERE st_identification_card = '0101234567';

-- Alerta 2: Carlos Mendoza (IN_PROGRESS, 11 días de ausencia, ya respondió)
INSERT INTO "RetentionAlerts" (
    re_al_id, re_al_student_id, re_al_user_id, re_al_contact_date, re_al_has_responded,
    re_al_days_absent, re_al_is_justified, re_al_justification_reason, re_al_return_deadline,
    re_al_observations, re_al_status, re_al_resolution_date, re_al_created_at, re_al_updated_at
...
-- Alerta 3: Sofia Rojas (RESOLVED, 17 días de ausencia, justificada)
INSERT INTO "RetentionAlerts" (
    re_al_id, re_al_student_id, re_al_user_id, re_al_contact_date, re_al_has_responded,
    re_al_days_absent, re_al_is_justified, re_al_justification_reason, re_al_return_deadline,
    re_al_observations, re_al_status, re_al_resolution_date, re_al_created_at, re_al_updated_at
...
SELECT 
    ...
    17, true, 'Certificado médico presentado por enfermedad.', null,
...
-- Alerta 4: Diego Silva (UNRESOLVED, 20 días de ausencia, no responde)
INSERT INTO "RetentionAlerts" (
    re_al_id, re_al_student_id, re_al_user_id, re_al_contact_date, re_al_has_responded,
    re_al_days_absent, re_al_is_justified, re_al_justification_reason, re_al_return_deadline,
    re_al_observations, re_al_status, re_al_resolution_date, re_al_created_at, re_al_updated_at
...
SELECT 
    ...
    20, false, null, null,
    'No se pudo establecer contacto tras múltiples intentos (llamadas y correos). Se congela el perfil.', 'UNRESOLVED', '2026-05-30', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM "Students" WHERE st_identification_card = '0104567890';

-- Alerta 5: Valentina Castro (PENDING, 13 días de ausencia)
INSERT INTO "RetentionAlerts" (
    re_al_id, re_al_student_id, re_al_user_id, re_al_contact_date, re_al_has_responded,
    re_al_days_absent, re_al_is_justified, re_al_justification_reason, re_al_return_deadline,
    re_al_observations, re_al_status, re_al_resolution_date, re_al_created_at, re_al_updated_at
