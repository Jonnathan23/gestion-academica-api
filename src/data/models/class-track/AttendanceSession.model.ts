...
class AttendanceSession extends Model<AttendanceSessionAttributes, AttendanceSessionCreationAttributes> {
    ...
    declare public at_se_id: string;
    ...
    declare public at_se_student_id: string;
    ...
    declare public at_se_teacher_id: string;
    ...
    declare public at_se_session_date: Date;

    @Column({
        type: DataType.DATE,
        allowNull: false,
    })
    declare public at_se_entry_time: Date;

    @Column({
        type: DataType.DATE,
        allowNull: true,
    })
    declare public at_se_exit_time: Date;

    @Column({
        type: DataType.INTEGER,
        allowNull: true,
    })
    declare public at_se_total_minutes: number;
    ...
    declare public at_se_status: AttendanceSessionStatus;

    @HasOne(() => LessonLog)
    declare public lesson_log: LessonLog;
}
