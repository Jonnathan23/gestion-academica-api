...
import { CreatePaymentPlanUseCase } from "@/app/AdminDesk/payments/application/useCases/CreatePayment.use-case";
import { GetStudentPaymentPlansUseCase } from "@/app/AdminDesk/payments/application/useCases/GetStudentPaymentPlans.use-case";
import { ProcessQuotaPaymentUseCase } from "@/app/AdminDesk/payments/application/useCases/ProcessQuotaPayment.use-case";
import { RevertQuotaPaymentUseCase } from "@/app/AdminDesk/payments/application/useCases/RevertQuotaPayment.use-case";
import { CreatePaymentPlanDto } from "@/app/AdminDesk/payments/domain/dtos";
import { PayQuotaDto } from "@/app/AdminDesk/payments/domain/dtos";
import { PaymentPlanEntity } from "@/app/AdminDesk/payments/domain/entities/PaymentPlanEntity";
import { PaymentQuotaEntity } from "@/app/AdminDesk/payments/domain/entities/PaymentQuotaEntity";
...
export class PaymentController {
    ...
    createPaymentPlan = (req: Request, res: Response, next: NextFunction) => {
        ...
        createPaymentPlan.execute(createPaymentPlanDto!)
            .then(paymentPlan => {
    ...
    getStudentPaymentPlans = (req: Request, res: Response, next: NextFunction) => {
        ...
        getStudentPaymentPlans.execute(studentId as string)
            .then(paymentPlans => {
    ...
    processQuotaPayment = (req: Request, res: Response, next: NextFunction) => {
        ...
        processQuotaPayment.execute(payQuotaDto!)
            .then(updatedQuota => {
    ...
    revertQuotaPayment = (req: Request, res: Response, next: NextFunction) => {
        ...
        revertQuotaPayment.execute(quotaId as string)
            .then(() => {
