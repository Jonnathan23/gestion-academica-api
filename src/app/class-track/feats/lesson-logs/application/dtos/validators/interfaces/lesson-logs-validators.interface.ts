...
export interface LessonLogsValidators {
    createLessonLogsValidator: EntityValidator<CreateLessonLogsProps>;
    getLastLessonLogValidator: EntityValidator<GetLastLessonLogProps>;
}
