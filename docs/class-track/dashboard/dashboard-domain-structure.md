...
_(No specific entities for Dashboard as it acts as an Aggregator / Read Model reusing the Attendance module)_

## DTOs

_(No specific DTOs for the Dashboard API endpoint)_
...
_(The Dashboard leverages repositories from the Attendance module)_
